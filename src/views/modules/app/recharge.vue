<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="from" header-align="center" align="center" label="谁充值的"></el-table-column>
      <el-table-column prop="hash" header-align="center" align="center" label="交易hash"></el-table-column>
      <el-table-column prop="blockNum" header-align="center" align="center" label="交易区块号"></el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" label="数量"></el-table-column>
      <el-table-column
        prop="type"
        header-align="center"
        align="center"
        label="(1 eos, 2 ETH, 3 USDT 4, TRX)"
      ></el-table-column>
  ...
  methods: {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/app/recharge/delete"),
          method: "post",
